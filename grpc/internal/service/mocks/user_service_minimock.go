...
//go:generate minimock -i github.com/prostasmosta/auth/grpc/internal/service.UserService -o ./mocks/user_service_minimock.go -n UserServiceMock
...
func (mmCreate *mUserServiceMockCreate) Expect(ctx context.Context, params *model.CreateUser) *mUserServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &UserServiceMockCreateParams{ctx, params}
...
func (mmCreate *mUserServiceMockCreate) Inspect(f func(ctx context.Context, params *model.CreateUser)) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Set(f func(ctx context.Context, params *model.CreateUser) (i1 int64, err error)) *UserServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserServiceMockCreate) When(ctx context.Context, params *model.CreateUser) *UserServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &UserServiceMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &UserServiceMockCreateParams{ctx, params},
	}
...
func (mmCreate *UserServiceMock) Create(ctx context.Context, params *model.CreateUser) (i1 int64, err error) {
	...
	mm_params := &UserServiceMockCreateParams{ctx, params}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockCreateParams{ctx, params}
	...
	mmCreate.t.Fatalf("Unexpected call to UserServiceMock.Create. %v %v", ctx, params)
	return
}
...
func (mmGet *mUserServiceMockGet) Return(gp1 *model.GetUser, err error) *UserServiceMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserServiceMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserServiceMockGet) Set(f func(ctx context.Context, id int64) (gp1 *model.GetUser, err error)) *UserServiceMock {
	if mmGet.defaultExpectation != nil {
...
func (e *UserServiceMockGetExpectation) Then(gp1 *model.GetUser, err error) *UserServiceMock {
	e.results = &UserServiceMockGetResults{gp1, err}
	return e.mock
}

// Get implements service.UserService
func (mmGet *UserServiceMock) Get(ctx context.Context, id int64) (gp1 *model.GetUser, err error) {
